import type { EventStore, Outbox, StoredEvent } from '@arts-n-crafts/ts'
import type { TimeEntryEvent } from '@modules/TimeRegistration/domain/TimeEntry/TimeEntry.decider.ts'
import type { Db } from 'mongodb'
import { createStoredEvent, fail, FieldEquals, invariant, makeStreamKey } from '@arts-n-crafts/ts'
import { buildMongoQuery } from '@modules/TimeRegistration/infrastructure/database/mongo/utils/buildMongoQuery.ts'
import { mapIdToMongoId } from '@modules/TimeRegistration/infrastructure/database/mongo/utils/mapMongoId.ts'
import { SameEntityOnly } from '@modules/TimeRegistration/specifications/SameEntityOnly.specification.ts'
