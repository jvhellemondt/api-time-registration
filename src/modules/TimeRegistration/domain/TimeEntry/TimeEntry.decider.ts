...
import type { TimeEntryRegisteredEvent } from '@modules/TimeRegistration/domain/TimeEntry/TimeEntryRegistered.event.ts'
import type { RegisterTimeEntryCommand } from '@modules/TimeRegistration/usecases/commands/RegisterTimeEntry/RegisterTimeEntry.command.ts'
